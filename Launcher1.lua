...
EzLauncher.StatusName.Text = "Py Armory"
...
EzLauncher.StatusName_2.Text = "Py API"
...
EzLauncher.StatusName_3.Text = "Py Launcher"
...
EzLauncher.NewsSection.Size = UDim2.new(1, -20, 0, 135)
...
local launcherData = game:GetService("HttpService"):JSONDecode(
	(game:HttpGet("https://raw.githubusercontent.com/pxeq/Ez-Industries-Launcher-Data/master/LauncherData.json")));
